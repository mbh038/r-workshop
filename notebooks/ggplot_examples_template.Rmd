...
I usually first create a summary of the data, in which calculate the means and standard error of the mean for each species for whatever variable I am inerested in, then feed this summary table to `ggplot` and use `geom_col()` to plot the bars, with `geom_errorbar()` on top of that to plot the error bars.
