...
# enter three lines of code to install the packages tidyverse, here and palmerpenguin
```

### Load the Palmer penguin data

For this exercise we use the Palmer penguins data set which comes with the package `palmerpenguin`
...
# enter the code to produce summary descriptive statistics on each column of the penguins data frame
...
We can now feed this to `ggplot()`
