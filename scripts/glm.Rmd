...
This type of data has low variance when proportions tend to be very low, around zero, or very high, around one. In between, peaking when the proportion is around 0.5 (50:50) the variance is at its greatest.
