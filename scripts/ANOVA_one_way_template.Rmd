...
Fill in or modufy the code in each of the code chunks below. Run each chunk as you, or even better, run each line using Ctrl-Enter or Cmd-Enter on a Mac. If you get an error, it will probably be a typ. Fix it and run the chunk again. repeat until the chunk works.
...
```{r}
# enter code to view the sructure of the penguins data set. Clue: glimpse()
